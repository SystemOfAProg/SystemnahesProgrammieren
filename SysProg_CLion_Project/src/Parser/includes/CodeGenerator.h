#ifndef PARSER_INCLUDES_CODEGENERATOR_H_
#define PARSER_INCLUDES_CODEGENERATOR_H_
...
class CodeGenerator: public ParseTreeVisitor {
public:
...
#endif /* PARSER_INCLUDES_CODEGENERATOR_H_ */
